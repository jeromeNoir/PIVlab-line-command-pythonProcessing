...
from piv_common import LOG_FILENAME, PIV_FILENAME, read_acquisition_params
...
# PIV field rate, the ROI/calibration constants and the acquisition-log reader
# come from piv_common (FRAMES_PER_FIELD, read_acquisition_params).
